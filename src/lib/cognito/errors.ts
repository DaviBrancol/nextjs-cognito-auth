const messages = {
  UserNotConfirmedException: 'You email has not been confirmed yet, check your email',
...
export function getCognitoErrorMessage(error: { code: string; message: string }) {
